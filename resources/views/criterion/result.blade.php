...
<div ng-controller="ResultController" ng-init="find({{$id}})">
	<div class="container">
		<ul class="nav nav-pills" >
			<li class="active" ng-show="showLeaf == true" ><a data-toggle="pill" href="#table">Leaf</a></li>
			<li ng-if="showLeaf == false" class="active"><a data-toggle="pill" href="#mainCriterian1" >Main Criterian</a></li>
			<li ng-if="showLeaf == true"><a data-toggle="pill" href="#mainCriterian" >Main Criterian</a></li>
			<li><a data-toggle="pill" href="#final">Final</a></li>
		</ul>
	</div>

	<div class="tab-content" ng-show="loadingData == true">
		<div id="table" class="tab-pane fade in active"  ng-show="showLeaf == true">
			<div class="container" >
				<div class="container" >
					<h3> Results</h3>
				</div>
		...
		<div id="mainCriterian" class="tab-pane" ng-show="loadingData == true && showLeaf == true">
			<div class="container" >
				<div class="container" >
					<h3> Main Criterian</h3>
				</div>
				<div ng-repeat = "nos in mainCriterian track by $index" >
					<div class="col-md-12" >
						<div class="container" >
						...
						<div class="container col-md-9" >
							<table class="table table-striped table-bordered table-hover table-sm">
							  ...
							  <tbody  >
							    <tr ng-repeat = "step in nos.criteria">
							      <th scope="row">@{{step.title}} - @{{step.name}}</th>
							      <td>@{{step.performaceMax}}</td>
							      <td class="bg-success">@{{step.performaceMedia}} </td>
							      <td>@{{step.performaceMin}}</td>
		...
		<div id="mainCriterian1" class="tab-pane fade in active" ng-show="loadingData == true && showLeaf == false">
			<div class="container" >
				<div class="container" >
					<h3> Main Criterian</h3>
				</div>
					        ...
					        <div class = "box-body ">
					            <div class="row">
									<canvas id="bar" class="chart chart-bar"
				  					chart-data="mainChart2Data" chart-labels="labelChart2" chart-options="optionsChart2" chart-series="serie">
									</canvas>
								</div>
					    	</div>    
		        		</div>	
